  ...
  return (
    ...
    id='home'>
      ...
      <p className='text-base text-textColor text-center md:text-left md:[80%]'>
        Selamat datang di U-Canteen kami menyediakan berbagai makanan untuk
        mengisi perut kosong kalian.
      </p>

      <button type='button' className='bg-gradient-to-br
       from-orange-400 to-orange-500 w-full
      ...
      <div className='py-2 flex-1 flex items-center relative'>
        <img 
        src={HeroBg} className="ml-auto 
        h-420 w-full lg:w-auto lg:h-650 " 
        alt="hero-bg" 
        />
        ...
        lg:px-32 py-4 gap-4 flex-wrap'>
          {heroData && heroData.map(n => (
             <div key={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center
             justify-center drop-shadow-lg'>
               <img src={n.imageSrc} 
               className='w-20 lg:w-40 -mt-10 lg:-mt-20' 
               alt="I1" />
               <p className='text:base lg:text-xl 
               font-semibold text-textColor mt-2 lg:mt-4'>
                 {n.name}
                  </p>
